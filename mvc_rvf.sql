...
--
-- Hôte : localhost
-- Généré le : ven. 20 jan. 2023 à 10:00
...
(2, 'Michael J. Fox', 'Marty cFly', 'https://www.pause-canap.com/media/wysiwyg/Marty-macfly.jpg'),
...
ALTER TABLE `comments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `movies_id` (`movies_id`,`users_id`),
